...
Ao correr a aplicação abrirá a janela do \textit{Jadex Control Center}, onde é necessário adicionar ao \textit{path} a pasta "\textit{application}" que se encontra dentro da pasta \textit{src} do projeto.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{addPath}
  \caption{Janela do \textit{path} do \textit{Jadex Control Center}.}
\end{figure}
